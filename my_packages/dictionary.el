...
;;
;; Changes:
;; 1. Added an interactive function so the user can lookup words,
;;    given in the mini-buffer.
;;
;; The skeleton of this file is provided by:
;; Evan Sultanik (http://www.sultanik.com/)
;;
...
(defun dictionary-word (word)
  "Let the user query a word given in the minibuffer."
  (interactive "sWord to check: ")
  (dict-lookup-word word t)
  )
