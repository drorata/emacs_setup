...
(custom-theme-set-faces
 ...
 '(flyspell-duplicate ((t (:foreground "selectedKnobColor" :underline t :weight bold))))
 '(font-latex-sectioning-5-face ((default (:foreground "DodgerBlue1" :weight semi-bold))
                                 (((type tty) (class color) (min-colors 256))
                                  (:foreground "#0087ff" :weight bold))))
 '(font-latex-sedate-face ((default (:foreground "green"))))
 ...
 '(font-lock-warning-face ((((type graphic))
                           ...
                           (((type tty))
                            (:inherit (error bold)))))
 '(highlight ((default (:background "darkgray" :inherit (default)))
              (((type graphic))
 ...
 '(region ((((type graphic)) (:foreground "black" :background "cyan1"))
           (((type tty) (class color) (min-colors 256))
            (:background "#0000af"))))
